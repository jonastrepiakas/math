...
\subsection{Small digression isotopies and their extensions}
...
to the depiction in Figure \ref{fig:N_3-1-jpg}. This 
is shown in 
Figure \ref{fig:part1-deformation-jpg}.

Suppose we look at the chandard chain of non-separating curves
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.6\textwidth]{part1-deformation.jpg}
    \caption{The}
    \label{fig:part1-deformation-jpg}
\end{figure}
...
\begin{figure}[htpb]
    ...
    \caption{many-klein-torus-curve.jpg}

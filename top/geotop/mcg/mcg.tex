...
\begin{itemize}
    ...
    \item Write notes for section 1.2.5 in Farb and Margalit.
...
\begin{itemize}
    \item How to understand intersection numbers? Any references?
...
\begin{definition}[]
    ...
    \right) \right) 
    \] 
    In other words, $\Mod(S)$ is the group of isotopy classes of
    elements of $\Homeo^{+} \left( S, \partial S \right) $, where
    isotopies are required to fix the boundary pointwise. If

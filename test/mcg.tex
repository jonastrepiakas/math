...
\begin{definition}[$\mathcal{M}_2$]
    ...
    the objects are bidecrated surfaces and morphisms are
    isotopy classes of diffeomorphisms restricting to the
    identity on a neighborhood of $I$.
\end{definition}
...
\end{remark}
    ...
    there is an action of the braid groupoid
     ...
     \subsubsection{Braiding inducing geometric representation}
